...
* *Multiple access methods*: Supporting CLI, desktop UI, and MCP protocol for AI assistant integration
...
|FR-06
|Provide desktop GUI for interactive use
|Medium
|===
...
|5
|*Extensibility*
|Pluggable LLM architecture via `LLMService` interface. Currently implemented with SKaiNET kllama, but extensible for future local backends.
|===
